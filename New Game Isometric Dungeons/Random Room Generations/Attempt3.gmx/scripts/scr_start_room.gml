///Width,height, Center, Centerx, Centery
...
instance_create(myroom_centerx*32*4,myroom_centery*32*4,obj_stairs_up)
instance_create(myroom_centerx*32*4,myroom_centery*32*4,obj_player)
