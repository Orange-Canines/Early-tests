...
{
draw_sprite_ext(sprSkillIcon,dir,view_xview+view_wview-12-16*dix,view_yview+13,1,1,0,c_black,1)
draw_sprite_ext(sprSkillIcon,dir,view_xview+view_wview-12-16*dix,view_yview+12,1,1,0,c_white,1)
dix += 1
}
dir += 1
}
...
gameover = "YOU DID NOT BECOME WASTELAND KING##KILLS: "+string(BackCont.kills)+"#LEVEL: "+string(BackCont.area)+"_"+string(BackCont.subarea)+"#DIFFICULTY: "+string(BackCont.hard)+"##PRESS ENTER TO RESTART"
